...
public class EnumClassInfo<E extends Enum<E>> {
    ...
    private EnumClassInfo(Class<E> enumType, String codeName, String user) {
    ...
    public static <E extends Enum<E>> EnumClassInfo<E> create(Class<E> enumType, String codeName, String user) {
